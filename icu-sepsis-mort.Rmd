...
Now we can fit our model with these hyperparameters.
...
roc <- roc(as.numeric(pred$data$response == 1), as.numeric(pred$data$truth == 1))
...
```{r}
imp_mat <- xgb.importance(model = mort_gbm2$learner.model)

...
xgb_lrn$par.vals <- list(booster = "gbtree", objective = "binary:logistic", 
                         nrounds = 100L, eval_metric = "auc")

params <- makeParamSet(makeIntegerParam("max_depth", lower = 5L, upper = 20L),
                       makeIntegerParam("gamma", lower = 1L, upper = 10L),
                       makeIntegerParam("min_child_weight", lower = 1L, upper = 10L),
                       makeNumericParam("eta", lower = 0.01, upper = 0.30),
                       makeNumericParam("subsample", lower = 0.1, upper = 0.5), 
                       makeNumericParam("colsample_bytree", lower = 0.1, upper = 0.5))
